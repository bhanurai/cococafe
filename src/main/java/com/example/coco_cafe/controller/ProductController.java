...
import com.example.coco_cafe.entity.Product;
import com.example.coco_cafe.service.CategoryService;
import com.example.coco_cafe.service.ProductService;
import com.example.coco_cafe.pojo.ProductPojo;
...
public class ProductController {
    ...
    private final ProductPojo productPojo;
    private final CategoryService categoryService;

    @Autowired
    public ProductController(ProductService productService, ProductPojo productPojo, CategoryService categoryService) {
    ...
    public String newProduct(@ModelAttribute("productForm") Product productForm, BindingResult bindingResult, Model model) {
        productPojo.validate(productForm, bindingResult);
