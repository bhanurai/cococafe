package com.example.coco_cafe.model;

import com.example.coco_cafe.creator.ProductCreator;
...
public class ProductEntityTests {
    ...
    public void createProductWhenImageUrlIsNotValidUrlShouldThrowException() {
        this.thrown.expect(ConstraintViolationException.class);
        this.thrown.expectMessage("org.hibernate.pojo.constraints.URL.message");
